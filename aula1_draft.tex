...
\begin{frame} 
	...
	\begin{outline}
		\1 Projeto
			...
			\2[-] {\scriptsize analógico ou digital}
		...
		\1 Grupos
			\2[-] {\scriptsize trabalho em grupo (4 pessoas)}
		
		\vspace{1em}
			    
		\1 Encerramento
			\2[-] {\scriptsize executação de \textit{playtests} com os protótipos}
			\2[-] {\scriptsize \textit{pitch} de 3 minutos(!)}
	\end{outline}
	...
	\begin{block}{\centering\textbf{ATENÇÃO!}}
		...
		\begin{outline}
			\1 As aulas ocorrem pela manhã, no período entre 09:00 e 12:00
				\2[-] {\scriptsize intervalo de 10 minutos às 10:00}
...
\begin{frame}
	...
	\begin{minipage}{3cm}
		...
		\begin{figure}
			\centering
			\includegraphics[draft,width=\textwidth]{pong-screenshot}
...
\begin{frame}
	...
	\begin{figure}
	    ...
	    \begin{subfigure}[!h]{0.25\paperwidth}
	    	\centering
	        \includegraphics[draft,height=0.2\paperheight]{chess-board}
	        \caption{\scriptsize\textbf{Xadrez}\footnotemark{}}
	    \end{subfigure}
	    \\[0.5em]
		\begin{subfigure}[!h]{0.35\paperwidth}
			\centering
	        \includegraphics[draft,height=0.2\paperheight]{cs-screenshot}
