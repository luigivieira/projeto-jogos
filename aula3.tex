...
% ---------------------------------------------------------------------------- %
\newcommand{\lessontitle}{Aula 3 - Executando testes e avaliações}
...
\begin{frame}{\textbf{GEQ: Game Experience Questionnaire}}
	...
	\begin{outline}
		\1 Dois questionários padronizados produzido pela Universidade de Tecnologia de Eindhoven (Holanda)
			\2[-] {\scriptsize baseados em todos os assuntos estudados até esta aula}
			\2[-] {\scriptsize para serem utilizados durante e após as sessões de jogos}

		\vspace{1em}

		\1 Contêm questões \emph{Likert} para avaliar oito aspectos da experiência
...
% ------------------------------
\begin{frame}{\textbf{Como obter o GEQ}}
	\centering
	Disponível\footnote{ainda somente em inglês, mas versões em outros idiomas (incluindo português) estão sendo produzidas} por solicitação via site:\\[1em]
	{\large \url{http://www.gamexplab.nl/index.php?page=contact}}
