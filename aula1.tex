...
\begin{frame} 
	...
	\begin{center}
		{\large
			Material do curso disponível em:\\[2em]
...
\begin{frame}
	...
	\begin{center}
		{\tiny \textbf{The Floor is Lava} by DerekHunter (\url{http://derekhunter.deviantart.com/art/The-Floor-is-Lava-276153571})}
	\end{center}
	\vspace{2em}
...
% ------------------------------
\begin{frame} 
	\frametitle{\textbf{Atividades lúdicas}}

    \begin{figure}
	    \centering
   		\includegraphics[height=0.5\paperheight]{types-of-play}
        \caption{A hierarquia de atividades lúdicas é decorrente do nível de interatividade \cite{Fullerton2008}}
    \end{figure}
...
\begin{frame} 
    ...
    \begin{figure}
	    \centering
        \includegraphics[height=0.7\paperheight]{taxonomy}
        \caption{A taxonomia das atividades lúdicas segue dois eixos, o do jogar-brincar e o do projeto todo-parte \cite{Groh2012}}
    \end{figure}
...
\begin{frame}
	...
	\begin{outline}
		...
		\1 Que engaja jogadores com conflitos estruturados

		\vspace{1em}
		
		\1 E resolve sua incerteza com resultados desiguais
	\end{outline}	
