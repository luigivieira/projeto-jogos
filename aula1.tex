...
\begin{frame} 
	...
	Considera-se também um eixo adicional, relacionado à forma do produto (ou processo) projetado:
    \begin{figure}
	    \centering
...
% ------------------------------
\begin{frame}
	\frametitle{\textbf{Jogo como sistema}}
	
	Esta é uma definição possível sobre o que é um jogo \cite{Fullerton2008}:

	\vspace{0.2em}
	
	\begin{outline}
		\1 Um sistema fechado e \emph{formal} (com regras)
	...
	A definição advém do mecanismo psicológico da atenção \cite{Koster2004}:
	...
	\begin{outline}
		...
		\1 Incertezas são padrões familiares ainda parcialmente entendidos
...
% ------------------------------
\begin{frame}
	\frametitle{\textbf{Jogo como meio}}

	O jogo é um meio de comunicação entre projetista (\textit{game designer}) e jogador (\textit{player})
...
% ---------------------------------------------------------------------------- %
\section{Desconstrução de jogos}
% ---------------------------------------------------------------------------- %
...
% ------------------------------
\begin{frame}
	\frametitle{\textbf{Atividade: desconstruindo jogos clássicos}}

	\vspace{-1.5em}

	\begin{center}
		Já em grupos, tente desconstruir os seguintes jogos:
	\end{center}
	...
	\begin{figure}
	    ...
	    \begin{subfigure}[!h]{0.25\paperwidth}
	        ...
	        \caption{\tiny\textbf{Pac-Man} \copyright{1980} Namco\footnotemark{}}
	    \end{subfigure}
	    ~
		\begin{subfigure}[!h]{0.25\paperwidth}
			\centering
	        \includegraphics[height=0.2\paperheight]{supermario-screenshot}
	        \caption{\tiny\textbf{Super Mario Bros.} \copyright{1985} Nintendo\footnotemark{}}
	    \end{subfigure}
	   	~
	    \begin{subfigure}[!h]{0.25\paperwidth}
	    	\centering
	        \includegraphics[height=0.2\paperheight]{chess-board}
	        \caption{\tiny\textbf{Xadrez} Índia (cerca de 500 d.C.)\footnotemark{}}
	    \end{subfigure}
	    \\[0.5em]
		\begin{subfigure}[!h]{0.25\paperwidth}
			\centering
	        \includegraphics[height=0.2\paperheight]{cs-screenshot}
	        \caption{\tiny\textbf{Counter-Strike} \copyright{1999} Valve\footnotemark{}}
	    \end{subfigure}
