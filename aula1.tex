...
\subsection{Ministrantes e motivação}
...
% ------------------------------
\begin{frame} 
	\frametitle{\textbf{Protótipo de jogo}}

	\begin{outline}
		\1 Projeto
			\2[-] {\scriptsize protótipo de baixa fidelidade de um jogo}
			\2[-] {\scriptsize preferencialmente analógico}
	    
		\vspace{1em}
	    
		\1 Atividades
			\2[-] {\scriptsize incrementais ao longo das aulas}
			\2[-] {\scriptsize construção iterativa do projeto}
	    
		\vspace{1em}
	    
		\1 Grupos
			\2[-] {\scriptsize trabalho em grupo (idealmente 4 pessoas)}
		
		\vspace{1em}
			    
		\1 Encerramento
			\2[-] {\scriptsize executação de \textit{playtests} com os protótipos}
			\2[-] {\scriptsize \textit{pitch} de 5 minutos(!) na última aula (sexta dia 22/01)}
	\end{outline}
	...
	\begin{block}{\centering\textbf{ATENÇÃO!}}
		...
		\begin{outline}
			\1 As aulas ocorrem pela manhã, no período entre 09:00 e 12:00
				\2[-] {\scriptsize intervalo de 15 minutos, as 10:30}
...
\begin{frame}
	...
	\begin{minipage}{3cm}
		...
		\begin{figure}
			\centering
			\includegraphics[width=\textwidth]{pong-screenshot}
	...
	\begin{minipage}{7cm}
		...
		\begin{outline}
			\1 {\scriptsize \textbf{Objetivo}: fazer a bolinha cruzar o fundo da área do adversário}
			\1 {\scriptsize \textbf{Condição de Término}: a bolinha ultrapassa a linha de fundo de um dos jogadores}
			\1 {\scriptsize \textbf{Ações}:}
				\2[-] {\scriptsize mover o bastão para cima}
				\2[-] {\scriptsize mover o bastão para baixo}
		\end{outline}
	...
	\begin{minipage}{\paperwidth}
		...
		\begin{outline}
			\1 {\scriptsize \textbf{Feedback}:}
				\2[-] {\scriptsize sinais sonoros do impacto da bolinha nos bastões, paredes e fundo de linha}
				\2[-] {\scriptsize alteração do placar numérico}
				\2[-] {\scriptsize movimentação dos bastões ao comando do jogador}
			\1 {\scriptsize \textbf{Estéticas de experiência}:}
				\2[-] {\scriptsize curiosidade da interação com computadores (há época)}
				\2[-] {\scriptsize desafio e passatempo}
				\2[-] {\scriptsize descoberta de habilidades (jogadas de efeitos)}
				\2[-] {\scriptsize interação social (``\textit{high score}'')}
				\2[-] {\scriptsize fantasia esportiva (tênis)}
		\end{outline}
